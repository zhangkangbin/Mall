...
public class AllOrderAdapter extends BaseAdapter {
    ...
    public AllOrderAdapter(LayoutInflater inflater, List<AllOrderBean.DataBean.GoodsListBean> list) {
    ...
    @Override
    public AllOrderBean.DataBean.GoodsListBean getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AllOrderBean.DataBean.GoodsListBean info = list.get(position);
